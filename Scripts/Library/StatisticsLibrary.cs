...
namespace woco_urogue {
	...
	public class StatisticsLibrary {
		...
		static private Dictionary<string, NumericStatisticTemplate> Dict;
		...
		static private void InstantiateLibrary() {
			if (Dict == null) Dict = new Dictionary<string, NumericStatisticTemplate>();
		...
		{
			InstantiateLibrary();
			NumericStatisticTemplate[] resources = Resources.LoadAll<NumericStatisticTemplate>(@"Statistics");
			foreach (NumericStatisticTemplate tmpl in resources) {
		...
		// GetStatus
		// -------------------------------------------------------------------------------
		static public NumericStatisticTemplate Get(string id) {
			InstantiateLibrary();
			NumericStatisticTemplate tmpl;
